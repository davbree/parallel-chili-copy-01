...
1. Navigate to the ["API Settings"](https://manage.sanity.io/projects/xfz24kiq/settings/api) page of this Sanity.io project. Then click "Add new token" and create new "write" token.
...
To start editing your site, you can use the Sanity interface at https://parallel-chili-9218a.sanity.studio/.
...
Generated at `2021-02-14T13:12:32.325Z` by Stackbit version `0.3.48`.